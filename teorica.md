...
* [Class 01 — Security Principles](#class-01--security-principles)

  * [Saltzer & Schroeder Principles](#saltzer--schroeder-principles)
  * [Takeaway](#takeaway-class-01)
* [Class 02 — Security Threats](#class-02--security-threats)

  * [Threat Categories](#threat-categories)
  * [Takeaway](#takeaway-class-02)
* [Class 03 — Anatomy of a Pentest](#class-03--anatomy-of-a-pentest)

  * [0. Scope Definition](#0-scope-definition)
  * [1. Reconnaissance and Intelligence Gathering](#1-reconnaissance-and-intelligence-gathering)
  * [2. Scanning](#2-scanning)
  * [3. Exploitation](#3-exploitation)
  * [3.1 Shell Access](#31-shell-access)
  * [3.2 Lateral Movement / Pivoting](#32-lateral-movement--pivoting)
  * [3.3 Log Cleaning](#33-log-cleaning)
  * [4. Privilege Escalation](#4-privilege-escalation)
  * [5. Install APT](#5-install-apt-advanced-persistent-threat)
  * [6. Reporting](#6-reporting)
* [Class 04 — Attack Vectors](#class-04--attack-vectors)

  * [Attack Vector Concepts](#attack-vector-concepts)
  * [Takeaway](#takeaway-class-04)
* [Class 05 — Defense](#class-05--defense)

  * [Defense Concepts](#defense-concepts)
  * [Closing](#closing-class-05)
* [Class 06 — Network Security](#class-06--network-security)

  * [Network Security Concepts](#network-security-concepts)
  * [Closing](#closing-class-06)
* [Class 07 — Social Engineering](#class-07--social-engineering)

  * [Social Engineering Concepts](#social-engineering-concepts)
  * [Closing](#closing-class-07)
...
**Security should survive public scrutiny.**
...
### Principle 6 — Least Privilege / Need-to-Know
...
**Reduce shared mechanisms across users.**
...
**Make attacks economically impractical.**
...
**Detect, log, and learn from breaches.**
...
### Category 1 — Common Threats

**High-frequency attacks across all sectors.**
...
### Category 2 — Hardware Threats

**Compromises through physical and device vectors.**
...
### Category 3 — Software Threats

**Exploits targeting code and application logic.**
...
**Threats in transit and protocol abuse.**
...
### Category 5 — Cloud and Identity Threats

**Modern exposures in hybrid and cloud-native stacks.**
...
### Category 6 — Insider and Third-Party Threats

**Risk from trusted users and partner ecosystems.**
...
### Category 7 — Ransomware and Extortion

**Business disruption plus financial pressure.**
...
### Category 8 — Emerging Threats

**New attack patterns from AI and connected systems.**
...
### Category 9 — Impact and Prioritization

**Focus defense where risk is highest.**
...
### Category 10 — Defense Priorities

**Practical baseline to reduce exposure fast.**
...
This phase involves planning the pentest, where goals, permissions, systems, and the level of information provided to pentesters are discussed.

The goal is to establish clear boundaries to avoid unauthorized actions.

### Useful Tools

* Documentation and project management tools, like Jira, Trello, or Notion, to track objectives and ensure organization.
* Scope management does not require specific hacking tools but rather documentation software.

---

## 1. Reconnaissance and Intelligence Gathering

In this phase, an extensive collection of public and visible information about the target is gathered using OSINT (Open Source Intelligence) techniques.

The objective is to compile as much data as possible without directly interacting with the target system.

### Tools

* **Maltego:** To create relationship maps between different entities.
* **theHarvester:** To gather emails, subdomains, and other public information.
* **Recon-ng:** An OSINT framework with various modules.
* **Shodan and Censys:** To see what is publicly accessible about the target on the internet.

---

## 2. Scanning

The goal here is to identify available hosts and services, open ports, and “interesting” addresses.

It also includes mapping possible vulnerabilities for future exploitation.

### Tools

* **Nmap:** For port and service scanning.
* **Masscan:** An extremely fast port scanner for large networks.
* **Nikto:** A web vulnerability scanner that identifies dangerous configurations and problems in web servers.
* **OpenVAS:** A vulnerability scanner to detect possible flaws in hosts and services.
* **dnsrecon or dnsenum:** For DNS enumeration, useful for finding subdomains and other records.
...
In this phase, identified vulnerabilities are exploited.

It may involve exploiting known CVEs, social engineering, or physical access.

### Tools

* **Metasploit Framework:** One of the most popular exploitation frameworks, with an extensive library of exploits.
* **Exploit-DB:** Exploit database where you can search for specific software vulnerabilities.
* **BeEF / Browser Exploitation Framework:** For attacks directed at browsers.
* **Responder and Inveigh:** Network Poisoning tools, useful for Man-in-the-Middle (MITM) attacks.
* **Social Engineering Toolkit / SET:** For social engineering tests, including phishing attacks.
...
* **Meterpreter / Metasploit:** Provides an interactive shell on compromised systems with various functionalities.

---

## 3.2 Lateral Movement / Pivoting

The goal here is to use the acquired access to reach other systems and networks in the infrastructure.

At this stage, the pentester moves laterally across the network.

### Tools

* **Mimikatz:** For credential extraction on the network, useful for lateral movement.
* **Impacket:** Set of scripts enabling SMB, RDP, and other interactions, facilitating lateral movement.
...
Deleting or modifying logs to hide activity.

This practice is fundamental to ensure the intrusion is not immediately detected.

### Tools

* Manual scripts or system’s own tools, such as Clear-EventLog in Windows PowerShell.
* **Metasploit / Meterpreter:** Includes options to clear logs after exploitation.

---

## 4. Privilege Escalation

The aim here is to increase privileges, for example from a limited user to root or administrator, to gain full access to the system.

If new privileges are obtained, the scanning and exploitation cycle is restarted from the new access level.

### Tools

* **LinPEAS:** To find potential escalation vectors on Linux systems.
* **WinPEAS:** Windows version.
* **PowerUp and SharpUp:** Privilege escalation tools in the Windows environment.
* **GTFOBins and LOLBAS:** Repositories of legitimate binaries and scripts that can be exploited for privilege escalation.

---

## 5. Install APT / Advanced Persistent Threat

A backdoor or another type of persistent access is configured to maintain long-term intrusion, if this is the goal of the test.

### Tools

* **Empire:** Framework for persistence attacks in Windows environments.
* **Pupy:** Remote access tool that allows creating backdoors on compromised systems.
* **C2 frameworks:** Cobalt Strike or Sliver, for open-source alternatives.

---

## 6. Reporting

The final pentest report documents all findings, successful exploits, and recommendations for improving security.

This is a critical document that should be clear, detailed, and accessible to all stakeholders, from technical to executive levels.

### Tools

* **Dradis:** For security report management and team collaboration.
* **MagicTree:** Data management tool for pentesting, allowing centralized and structured information.
* **Faraday:** Collaborative IDE for security teams that supports report creation.
...
## Attack Vector Concepts

### Framing — What Is an Attack Vector?

**A path used to reach a target or trigger a compromise.**
...
**External attackers start with exposed surfaces.**
...
### Outside — Vulnerable Software

**Exposed services create remote attack paths.**
...
### Outside — Vulnerable People

**External attackers often start with manipulation.**
...
### Outside — Vulnerable Hardware and Locks

**Physical weaknesses can become remote entry enablers.**
...
**Internal access changes the attacker’s advantages.**
...
### Inside — Vulnerable Network and Software

**Internal trust often hides exploitable paths.**
...
### Inside — Vulnerable People and Hardware

**Internal compromise still depends on human and physical weakness.**
...
### Cross-Cutting — Human Factor

**People connect outside and inside attack paths.**
...
### Visual Example — Attack Surface Extension
...
### Framing — Defense Starts With the Right Model
...
### Frameworks — Kill Chain, Diamond, MITRE, NIST
...
### Visibility — The Visibility Triad
...
### Perimeter — Network and Edge Controls
...
### Endpoint — From Antivirus to EDR
...
### Detection — IDS, SIEM, and Network Telemetry
...
### Active Defense — Deception as Detection
...
### After the Breach — Forensics and Incident Response
...
### Takeaway — So, Is Defense Possible?
...
### Physical Layer — Signals Can Leak
...
### Link Layer — Local Networks Are Trusting
...
### Link Layer — ARP and DHCP Spoofing
...
### Transport Layer — TCP Session Attacks
...
### Application Layer — DNS and SSL Interception
...
### Defenses — Secure Channels and Encryption
...
### Defenses — Control, Trace, and Deceive
...
### Framing — People Are Part of the System
...
### Psychology — Trust, Pressure, Habit
...
### Techniques — Pretext, Bait, Impersonation
...
### Reconnaissance — OSINT Makes It Personal
...
### Targeting — Profiles Become Pretexts
...
### Tooling — SET and Simulation Tools
...
### Modern Tooling — Modern Attack Platforms
...
### Physical — Physical and Hybrid Attacks
...
### Defense — Reduce Damage, Improve Reporting
...
### Defense — Technical and Cultural Controls
...
### Boundaries — Ethics and Authorization
